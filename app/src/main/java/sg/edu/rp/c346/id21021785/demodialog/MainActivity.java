package sg.edu.rp.c346.id21021785.demodialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnDemo1a, btnDemo2, btnDemo3, btnEx3, btnDemo4, btnDemo5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDemo1a = findViewById(R.id.buttonDemo1);
        ...
        btnDemo1a.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                LayoutInflater inflater =
                        (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View viewDialog = inflater.inflate(R.layout.exercise3_layout, null);
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        double total = input1Double + input2Double;
                        // Set the text to the TextView
                        tvEx3.setText(total + "");
                    }
                });
